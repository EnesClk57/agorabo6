...
class __TwigTemplate_5d866e240936ce1142a8b2fed1b652f9 extends Template
{
    ...
    ";
        // line 8
        yield Twig\Extension\CoreExtension::include($this->env, $context, "membres/_form.html.twig", ["button_label" => "Update"]);
        yield "
...
{% block body %}
    ...
    {{ include('membres/_form.html.twig', {'button_label': 'Update'}) }}

    <a href=\"{{ path('app_membres_index') }}\">back to list</a>

    {{ include('membres/_delete_form.html.twig') }}
{% endblock %}
", "membres/edit.html.twig", "C:\\wamp64\\www\\agorabo7\\templates\\membres\\edit.html.twig");
    }
}
