...
class __TwigTemplate_b4ff454d095a074d251bc5a9c4bc235e extends Template
{
    ...
    <table class=\"table\">
        ...
        yield "</td>
            ...
            <tr>
                ...
                <td>";
        // line 20
        ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["membre"]) || array_key_exists("membre", $context) ? $context["membre"] : (function () { throw new RuntimeError('Variable "membre" does not exist.', 20, $this->source); })()), "roles", [], "any", false, false, false, 20)) ? (yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(json_encode(CoreExtension::getAttribute($this->env, $this->source, (isset($context["membre"]) || array_key_exists("membre", $context) ? $context["membre"] : (function () { throw new RuntimeError('Variable "membre" does not exist.', 20, $this->source); })()), "roles", [], "any", false, false, false, 20)), "html", null, true)) : (yield ""));
        yield "</td>
            </tr>
            <tr>
                <th>Password</th>
    ...
    <a href=\"";
        // line 59
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_membres_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["membre"]) || array_key_exists("membre", $context) ? $context["membre"] : (function () { throw new RuntimeError('Variable "membre" does not exist.', 59, $this->source); })()), "id", [], "any", false, false, false, 59)]), "html", null, true);
        yield "\">edit</a>
...
{% block body %}
    ...
    <a href=\"{{ path('app_membres_index') }}\">back to list</a>

    <a href=\"{{ path('app_membres_edit', {'id': membre.id}) }}\">edit</a>

    {{ include('membres/_delete_form.html.twig') }}
{% endblock %}
", "membres/show.html.twig", "C:\\wamp64\\www\\agorabo7\\templates\\membres\\show.html.twig");
    }
}
