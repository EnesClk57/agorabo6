...
class __TwigTemplate_2236df48bcc5b2bdd1402c92c4ae66f1 extends Template
{
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["membre"]) {
            ...
            yield "</td>
                <td>";
            // line 30
            ((CoreExtension::getAttribute($this->env, $this->source, $context["membre"], "roles", [], "any", false, false, false, 30)) ? (yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(json_encode(CoreExtension::getAttribute($this->env, $this->source, $context["membre"], "roles", [], "any", false, false, false, 30)), "html", null, true)) : (yield ""));
            yield "</td>
                <td>";
            // line 31
            ...
            yield "</td>
                <td>
                    <a href=\"";
            // line 40
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_membres_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["membre"], "id", [], "any", false, false, false, 40)]), "html", null, true);
            yield "\">show</a>
                    <a href=\"";
            // line 41
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_membres_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["membre"], "id", [], "any", false, false, false, 41)]), "html", null, true);
            yield "\">edit</a>
                </td>
            </tr>
        ";
...
";
    ...
    {
        return array (  202 => 52,  197 => 49,  188 => 45,  179 => 41,  175 => 40,  170 => 38,  166 => 37,  162 => 36,  158 => 35,  154 => 34,  150 => 33,  146 => 32,  142 => 31,  138 => 30,  134 => 29,  130 => 28,  127 => 27,  122 => 26,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    ...
    <table class=\"table\">
        ...
        {% for membre in membres %}
            <tr>
                ...
                <td>
                    <a href=\"{{ path('app_membres_show', {'id': membre.id}) }}\">show</a>
                    <a href=\"{{ path('app_membres_edit', {'id': membre.id}) }}\">edit</a>
                </td>
            </tr>
        {% else %}
            <tr>
    ...
    <a href=\"{{ path('app_membres_new') }}\">Create new</a>
{% endblock %}
", "membres/index.html.twig", "C:\\wamp64\\www\\agorabo7\\templates\\membres\\index.html.twig");
    }
}
