...
/* messages.html.twig */
class __TwigTemplate_ffe59873d06c2add3fd14c274f80ac5d extends Template
{
    ...
    public function block_flash_messages(array $context, array $blocks = []): iterable
    {
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 2, $this->source); })()), "session", [], "any", false, false, false, 2), "flashbag", [], "any", false, false, false, 2), "all", [], "method", false, false, false, 2));
...
";
    ...
    {
        return array (  87 => 7,  80 => 4,  76 => 3,  72 => 2,  49 => 1,);
    }
...
{% endfor %}
{% endfor %}
{% endblock %}", "messages.html.twig", "C:\\wamp64\\www\\agorabo7\\templates\\messages.html.twig");
    }
}
